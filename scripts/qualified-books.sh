...
curl --include --request PATCH http://localhost:3000/qualified_books/340 \
  --header "Authorization: Token token=BAhJIiU2NDdkMjU5OWNjMWZmNDA2NjFiMGY0NzZlYzZkZTg3NwY6BkVG--4f606b3800bb3aaa8fa37856c77e35b9c8418fa2" \
  --header "Content-Type: application/json" \
  --data '{
    "qualified_book": {
      "user_id": "1",
